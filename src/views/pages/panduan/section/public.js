...
const Public = () => {
	return (
		<section id="panduan-public" className="panduan-public">
						...
						<div className="card mb-5 justify-content-center align-self-center" data-aos="fade-up" data-aos-delay={100}>
							<div className="row g-0">
								<div className="col-md-2 d-none d-lg-block d-xl-block">
									<img className="img-fluid position-absolute top-0 start-0 translate-middle" src={panduanPublicImg} alt="about_img_01" />
								</div>
								...
								<div className="col">
									<div className="card-body content-text">
										<h4 className="card-title">Website Publik</h4>
